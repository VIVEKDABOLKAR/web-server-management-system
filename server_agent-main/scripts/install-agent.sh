...
JAR_NAME="server-agent.jar"
JAR_INSTALL_PATH="https://drive.google.com/uc?export=download&id=1cDO-Ns1kDsxgRXL-yY7_XnWcm4bjNa8m"
...
ExecStart=/usr/bin/java -jar ${INSTALL_DIR}/${JAR_NAME} ${AGENT_ARGS}
